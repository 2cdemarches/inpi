...
async function getFormalite(id) {
  const sb = adminSb();
  // Récupérer les tokens depuis la table settings (premier utilisateur avec INPI configuré)
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-lg mx-auto px-5 py-6 space-y-4">
        ...
        <p className="text-center text-xs text-slate-400">Mis à jour automatiquement · Formalité n°{id}</p>
      </div>
    </div>
  );
}

...
export async function generatePdf(sourcePath, docType, client) {
  ...
  // 3. Post-traitement HTML : ajouter classe .titre-section aux paragraphes TITRE I/II/...
  html = html.replace(/<p>(<strong>TITRE\s/g, '<p class="titre-section"><strong>TITRE ');
...
br { content: ""; display: block; margin-top: 4pt; }

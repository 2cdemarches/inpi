...
export async function generatePdf(sourcePath, docType, client) {
  ...
  // 3 lignes d'espace avant "Le soussigné :"
...
export async function htmlToPdf(html) {
  ...
  try {
    ...
    return await page.pdf({
      ...
      footerTemplate: `<div style="width:100%;text-align:center;font-size:9pt;font-family:Tahoma,Arial,sans-serif;color:#000;padding-bottom:4px;">
        <span class="pageNumber"></span>
      </div>`,
      margin: { top: '2.5cm', right: '2.5cm', bottom: '2cm', left: '2.5cm' },
    });
  } finally {
    await browser.close();
  }

...
function getReplacements(docType, client, settings = {}) {
  ...
  const common = [
    ...
    ['{capital_lettres}',         nombreEnLettres(client.capital)],
  ...
  const statuts = [
    ...
    [`cent (${client.capital})`,      `${nombreEnLettres(client.capital)} (${client.capital})`],
    [`cent (100)`,                    `${nombreEnLettres(client.capital)} (${client.capital})`],
    [`de cent euros`,                 `de ${nombreEnLettres(client.capital)} euros`],
    [`cent euros`,                    `${nombreEnLettres(client.capital)} euros`],
